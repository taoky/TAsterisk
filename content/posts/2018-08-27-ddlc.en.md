...
_DDLC_ is based on the Ren'Py engine, and you can easily find projects[^2] unpacking and decompiling files of Ren'Py on GitHub. So it's not so hard to see what's inside _DDLC_.
